...
namespace DeskBooker.Core.Tests.Processar
{
    ...
    {
        private readonly DeskBookerRequest _request;
        ...
        {
            _request = new DeskBookerRequest
            {
                FirstName = "Jesus",
                LastName = "Vaz",
                Email = "adrianovaz2gamil.com",
            ...
            _processor = new(_deskBookingRepositoryMock.Object, _deskRepositoryMock.Object);
        }
        //Class
        //request
        [Fact]
        ...
        public void ShouldSaveDeskBooking()
        {
            ...
            _deskBookingRepositoryMock.Setup(x => x.Save(It.IsAny<DeskBooking>())).Callback<DeskBooking>(desk =>
            {
                savedDeskBooking = desk;
            });
        ...
        public void ShouldReturnExpextedResultCode(DeskBookingResultCode expectedResulCode, bool isDeskAvailable)
        {
            if (!isDeskAvailable)
            {
                _availableDesks.Clear();
            ...
            Assert.Equal(expectedResulCode, result.Code);
        }
        ...
        public void ShouldReturnExpextedDeskBookingId(int? expectedDeskBookingId, bool isDeskAvailable)
        {
            if (!isDeskAvailable)
            {
                _availableDesks.Clear();
